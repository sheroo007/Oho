...
#==========================================================
# SmartComboSimple.pl v1.4 (production)
# - At saveMap: run autosell once per arrival
# - At lockMap: if overweight (player/cart) -> return to save via SmartCore::smart_tele(2)
# - Respects busy AI states; has small delays/cooldowns; no conflict with other smart plugins
#==========================================================
...
sub _autoDelay () {      (_cfg('smartSimple_autosell_delay_ms',300)+0) / 1000.0 }
...
sub _use_central_teleport_to_save {
    # central helper; success returns true
